...
/**
 * Precompiled composeapp.ruler-conventions script plugin.
 **/
public class ComposeappRulerConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_ComposeappRulerConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("com.spotify.ruler");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ComposeappRulerConventions").asSubclass(BasicScript.class);
