...
/**
 * Precompiled composeapp.spotless-conventions script plugin.
 **/
public class ComposeappSpotlessConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_ComposeappSpotlessConventions").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ComposeappSpotlessConventions").asSubclass(BasicScript.class);
