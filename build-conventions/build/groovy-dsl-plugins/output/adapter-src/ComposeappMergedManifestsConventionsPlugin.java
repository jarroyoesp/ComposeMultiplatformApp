...
/**
 * Precompiled composeapp.merged-manifests-conventions script plugin.
 **/
public class ComposeappMergedManifestsConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ComposeappMergedManifestsConventions").asSubclass(BasicScript.class);
