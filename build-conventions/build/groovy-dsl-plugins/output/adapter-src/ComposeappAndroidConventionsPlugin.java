...
/**
 * Precompiled composeapp.android-conventions script plugin.
 **/
public class ComposeappAndroidConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_ComposeappAndroidConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("composeapp.detekt-conventions");
            target.getPluginManager().apply("kotlin-android");
            target.getPluginManager().apply("kotlin-kapt");
            target.getPluginManager().apply("kotlin-parcelize");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ComposeappAndroidConventions").asSubclass(BasicScript.class);
