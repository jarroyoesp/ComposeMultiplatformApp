...
/**
 * Precompiled composeapp.dependencies-conventions script plugin.
 **/
public class ComposeappDependenciesConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ComposeappDependenciesConventions").asSubclass(BasicScript.class);
